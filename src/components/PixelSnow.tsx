...
export default function PixelSnow({
  ...
  }, [handleResize, flakeSize, minFlakeSize, pixelResolution, speed, depthFade, farPlane, brightness, gamma, density, variantValue, direction, colorVector]); // Only recreate scene when handleResize changes
